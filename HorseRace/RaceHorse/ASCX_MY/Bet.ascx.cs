...
public partial class ASCX_Bet : System.Web.UI.UserControl
{
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        loc_sMatchInfoID = raceinfo.GetRaceInfoID_MY(sHorseNo, sSN);
        loc_dPrice = raceinfo.GetPrice_MY(sHorseNo, sSN);
        ...
        if (loc_daccount > 0)
        {
            if (loc_daccount > loc_dUp * int.Parse(loc_sHeadAmount) + loc_dDown * int.Parse(loc_sFootAmount))
            {
                ...
                ante.InsertAnte_MY(loc_sMatchInfoID, loc_sHeadAmount, loc_sFootAmount, loc_sUserID);
