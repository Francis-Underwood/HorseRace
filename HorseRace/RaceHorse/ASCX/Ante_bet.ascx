        ...
        <table style="width: 280px; height: 131px; border-top-style: ridge; border-right-style: ridge; border-left-style: ridge; border-bottom-style: ridge;">
            ...
            <tr>
                <td colspan="4" width = "60%" style="height: 7px" align="right">
                    <asp:Button ID="btnConceal" runat="server" Text="<%$ Resources:btnConcealResource.Text %>" OnClick="btnConceal_Click" /></td>
                <td colspan="2" width ="40%" style="height: 7px">
                    <asp:Button ID="btnSubmin" runat="server" Text="<%$ Resources:btnSubminResource.Text %>" Width="90px" OnClick="btnSubmit_Click" ValidationGroup="va_Ante" /></td>
