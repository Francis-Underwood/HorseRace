...
public partial class ASCX_Antelist : System.Web.UI.UserControl
{
    ...
    private void GridViewDataBind()
    {
        ...
        GridViewAnteList.DataSource = ante_RI.ShowAnte_Race_SGInfoList();
    ...
    protected void GridViewAnteList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Attributes.Add("OnClick", "javascript:window.open(\"Eat.aspx?SN=" + sSN + "&HorseNo=" + sHorseNo + "&HeadAmount=" + sHeadAmount + "&FootAmount=" + sFootAmount + "&Price=" + sPrice + "&Up=" + sUp + "&Down=" + sDown + "\",\"newwin\", \" height=100, width=400, top=300,left=400, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no,status=no\")");
