        ...
        <table style="width: 280px; height: 131px; border-top-style: ridge; border-right-style: ridge; border-left-style: ridge; border-bottom-style: ridge;">
            <tr>
                <td colspan="6" align="left" style="border-top-style: ridge; border-right-style: ridge; border-left-style: ridge; background-color: #ffcc33; border-bottom-style: ridge">
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial Black" Text="<%$ Resources:LabelResource3.Text %>"
            ...
            <tr>
                <td width ="10%" height="5%" align="center" style="width: 14%; border-top-style: solid; border-right-style: solid; border-left-style: solid; border-bottom-style: solid">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:LiteralResource1.Text %>"></asp:Literal></td>
                <td width ="10%" height="5%" align="center" style="width: 14%; border-top-style: solid; border-right-style: solid; border-left-style: solid; border-bottom-style: solid">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:LiteralResource2.Text %>"></asp:Literal></td>
                <td width ="20%" height="5%" align="center" style="width: 14%; border-top-style: solid; border-right-style: solid; border-left-style: solid; border-bottom-style: solid">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:LiteralResource3.Text %>"></asp:Literal></td>
                 <td width ="20%" height="5%" align="center" style="width: 14%; border-top-style: solid; border-right-style: solid; border-left-style: solid; border-bottom-style: solid">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:LiteralResource4.Text %>"></asp:Literal></td>
                ...
                <td height="5%" align="center" style="width: 14%; border-top-style: solid; border-right-style: solid; border-left-style: solid; border-bottom-style: solid;">
                     <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources: LiteralResource6.Text %>"></asp:Literal></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4" width = "60%" style="height: 7px" align="right">
                    <asp:Button ID="btnConceal_Gam" runat="server" Text="<%$ Resources: tnConceal_GamResource.Text %>" OnClick="btnConceal_Gam_Click" /></td>
                <td colspan="2" width ="40%" style="height: 7px">
                    <asp:Button ID="btnSubmit_Gam" runat="server" Text="<%$ Resources: btnSubmit_GamResource.Text %>" Width="90px" OnClick="btnSubmit_Gam_Click" ValidationGroup="va_Gam"/></td>
