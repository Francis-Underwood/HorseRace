<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Input.aspx.cs" Inherits="BackGround_News_Input"
...
<body>
    <form id="form1" runat="server">
        <table border="1" cellpadding="5" width="100%">
            <tr>
                <th colspan="2">
                    <asp:Literal ID="literalGeneral" runat="server" Text="管理新闻" />
                    <asp:TextBox ID="txtURL" runat="server" Style="display: none" />
                </th>
            </tr>
            <tr>
                <td width="20%">
                    <asp:Literal ID="literalTitle" runat="server" Text="新闻标题" />
                </td>
                <td width="80%">
            ...
            <tr>
                <td>
                    <asp:Literal ID="literalContent" runat="server" Text="新闻内容" />
                </td>
                <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="新闻标题不能为空"
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="FreeTextBox1"
            Display="None" ErrorMessage="新闻内容不能为空"></asp:RequiredFieldValidator>
